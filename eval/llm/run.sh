...
inspect eval eval/llm/starsim.py --model anthropic/claude-opus-4-20250514 --temperature 0
...
inspect eval eval/llm/starsim.py --model anthropic/claude-opus-4-20250514 --temperature 0 -T with_background=False -T with_test_cases=False
